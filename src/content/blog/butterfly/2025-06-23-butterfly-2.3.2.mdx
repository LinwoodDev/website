...
After a releasing the first beta of Butterfly Black Hairstreak (2.4) last week, the hotfix 2.3.2 for Butterfly is now available. This release includes all bug fixes from the beta. It's highly recommended to update to this version.
