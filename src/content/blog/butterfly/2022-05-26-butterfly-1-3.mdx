...
Download the latest version from [GitHub](https://github.com/LinwoodCloud/Butterfly/releases/v1.3.0).

## New features

### Areas

![Area screenshot](https://raw.githubusercontent.com/LinwoodCloud/Butterfly/develop/docs/docs/area.png)
