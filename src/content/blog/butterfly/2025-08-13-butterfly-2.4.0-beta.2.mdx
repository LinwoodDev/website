...
Starting with Butterfly 2.4.0-beta.3, the minSdkVersion gets increased from 23 to 24 since Flutter 3.35 depend on this.
This means, you need Android Nougat (Android 7) or higher to run the app.
