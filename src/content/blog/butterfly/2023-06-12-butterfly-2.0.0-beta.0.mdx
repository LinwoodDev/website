...
* Add navbar ([#391](https://github.com/LinwoodDev/Butterfly/issues/391))
    * Layers view
    * Pages view
    * Files view
* Add pages
...
* Bump file version
    * Painters and tool is now global instead of page specific and was moved to a info.json file
