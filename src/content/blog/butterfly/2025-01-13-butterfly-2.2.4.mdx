...
After a releasing a big 2.2.3 update last year, the hotfix 2.2.4 for Butterfly. is now available. This release includes many bug fixes particularly for corrupted files. It's highly recommended to update to this version.
