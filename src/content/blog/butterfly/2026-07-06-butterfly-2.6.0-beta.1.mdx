...
*This blog post has the OneNote importer missing. See [the next beta](https://linwood.dev/butterfly/2.6.0-beta.2) for the OneNote importer highlight.*
...
This is can be used for a highlighter stroke that was drawn in multiple parts, or for a complex shape that was drawn in several pieces.
